...
class Apa(object):
    ...
    def zero_ledrange(self, start, end):
        """zero_ledrange() zeroes stored led_values
        without writing their values to the LEDs.
        i.e. total reset but don't display yet"""
...
if __name__ == "__main__":
    ...
    print("Setting different temperaturecolours to 8 LEDS (8th one is black = OFF)")
...
__ledstrip.flush_leds() sends 4 null bytes to spi 0 on CE1 to 'wake' the 
APA102c LEDs
